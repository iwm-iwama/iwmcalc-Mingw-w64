...
:: set op_link=-Os -Wall -Wextra -lgdi32 -luser32 -lshlwapi -lcomdlg32 -lole32 -loleaut32 -luuid
::   -Wl,-subsystem,windows
::   -static -lgmp -lpdcurses -lpsapi -lpthread
set op_link=-Os -Wall -Wextra -lshlwapi -static -lmruby
